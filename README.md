...
```javascript
import readJSON from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-read-json@v0.2.4-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { sync } from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-read-json@v0.2.4-deno/mod.js';
```
